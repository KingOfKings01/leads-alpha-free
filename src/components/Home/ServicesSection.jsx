...
export default function ServicesSection() {
  return (
    <div className="flex flex-wrap p-[4vh_5vw] bg-white">

            {/* Box-1 */}
            <div className="w-1/2 p-4 flex gap-5 max-md:w-full max-md:flex-col">
            ...
            {/* Box-2 */}
            <div className="w-1/2 p-4 text-sm font-light leading-relaxed flex items-center self-start max-md:w-full max-md:pt-0">
              <p>
